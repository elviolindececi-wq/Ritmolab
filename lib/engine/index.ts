...
export {
  ...
  generateMelodyNotes, generatePattern, generateDistractors, patternToHits,
...
export type { TodayTrainingPlan, TrainingFocus, WorldProgress, WorldSessionStep } from "./lifelong-training";
export {
  generateTodayTrainingPlan, getSkillDecayStatus, buildWorldProgress,
  generateWorldSession, labelForExercise,
} from "./lifelong-training";

export { inferSkillFromLessonSlug, progressToPracticeSessions } from "./session-adapters";
