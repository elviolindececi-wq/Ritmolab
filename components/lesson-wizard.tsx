...
function LessonExperienceMobileStep({ module, step }: { module: Module; step: Step }) {
  ...
  // Mobile exercises: render the real interactive experience, not a placeholder.
  return (
    <div className="space-y-4">
      <div className="rounded-3xl border border-brand-100 bg-brand-50 p-5">
        <p className="text-xs font-black uppercase tracking-wide text-brand-700">Paso 3 de 3</p>
        <h3 className="mt-1 text-2xl font-black">Demostrá que lo entendiste</h3>
        <p className="mt-2 text-sm font-bold text-zinc-600">Resolvé los ejercicios interactivos para guardar XP, ver estrellas y recibir feedback formativo.</p>
      </div>
      <LessonExperience module={module} />
    </div>
  );
}
