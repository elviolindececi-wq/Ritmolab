  ...
  return (
    <div className="container-page py-10">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 mb-8">
        <div>
          <p className="pill">8 mundos · {totalLessons} lecciones</p>
          <h1 className="mt-4 text-5xl font-black">Aprender ritmo</h1>
          <p className="mt-3 max-w-2xl text-lg text-zinc-600">
            Avanzá de pulso hasta polirritmia. Cada mundo construye sobre el anterior.
          </p>
        </div>
        {completedCount > 0 && (
